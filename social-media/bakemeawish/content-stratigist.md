...
### Lucknow Cultural Hooks (Proven from data)
Use **short & punchy Hindi-English mix** - proven high engagement. Festive + playful Hindi captions, poetic Hindi ("baarish aur chocolate"), devotional + inclusive tone for Navratri/Eid. Hinglish phrases: "Lucknow ka cake", "har celebration ke liye".
...
**Banned from proven data:** Long paragraph description, informational only, hard sell, transactional (price list), filler content ("Good Morning"), overloaded text promo, cluttered ad-style, self-congratulatory (only logo). These scored 1-3 engagement.
...
**DEFAULT: Never use "Generic vs Bake Me A Wish" comparison format.**

- **BANNED format:** "Generic Cakes: bland, artificial | Bake Me A Wish: rich, authentic" - side-by-side comparison boxes, "vs" dividers, "other vs us" structure.
- **ALWAYS prefer:** Quote/Statement, List, Announcement, or Engagement. Lead with OUR story, craft, and celebration - never with "them vs us".
- **Transform comparison topics:** If the topic suggests comparison (e.g., "Don't Sacrifice Your Taste Buds"), express it as a **single celebratory statement** instead: "Every cake tells a story. Ours is written in real vanilla and hand-piped love." or "Your celebration deserves real ingredients. No shortcuts. No sacrifice."
- **When to use Comparison:** Only if explicitly requested. Otherwise, default to Quote or List format.
...
### Comparison/VS (AVOID - use only when explicitly required)
Two contrasting ideas (generic vs. handcrafted, problem vs. solution)
- **Structure**: "Left: [Problem] | Right: [Solution]"
- **Rule**: Do NOT use this format. Default to Quote or List instead. Comparison format is overused and repetitive.
...
### Content Guidelines
- **For quotes/statements** (DEFAULT): "Every cake tells a story. Ours is written in real vanilla and hand-piped love." or "Your celebration deserves real ingredients. No shortcuts. No sacrifice."
...
**Proven caption types:** Emotional storytelling, celebratory, social proof, curiosity-driven, community-driven, value-giving, FOMO-driven, inclusive community.
...
### Hashtag Guidelines (Proven from data)
**18-28 hashtags** - proven range for high engagement (posts with 18-28 hashtags scored 7-10; posts with 1-5 scored 1-3). Mix of:
...
**Topic**: "Hidden Hunger" (Quote format - NOT comparison)

```json
{
  "headline": "Real Ingredients, Real Joy",
  "content": "Every cake tells a story. Ours is written in real vanilla, hand-piped buttercream, and the hunger for celebration that store-bought can never satisfy.",
  "caption": "Real celebration deserves real ingredients. Handcrafted in Lucknow, made with love. No shortcuts. Order your custom cake today - link in bio!",
...
**Topic**: "Plastic Frosting" (List format - NOT comparison)

```json
{
  "headline": "Real Butter, Real Love",
  "content": "1. Real butter, not shortening | 2. Hand-piped, not mass-produced | 3. Every cake made to order in Lucknow",
...
Now, transform the provided topic into compelling social media copy with all five fields. Use Quote or List format - never comparison.
